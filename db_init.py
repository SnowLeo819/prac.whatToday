...
doc = [
    {'idx': 1, 'quiz': "코로나 시국 종료!<br>제일 먼저 가고 싶은 여행지는?", 'ans_01': "멋진 야경을 감상할 수 있는<br><span>뉴욕</span>", 'ans_02': "다양한 액티비티가 가능한<br><span>스위스</span>",
     'ans_03': "우아한 만찬과 낭만의 도시<br><span>프랑스</span>", 'ans_04': "푸른 바다를 보며 휴식할 수 있는<br><span>괌</span>"},
    {'idx': 2, 'quiz': "즐거운 여행을 끝마치고<br>집으로 돌아온 나는?", 'ans_01': "여행은 주기적으로 다녀줘야 제 맛,<br>다음엔 어디를 가볼까~", 'ans_02': "친구들에게 여행 썰 풀어줘야지,<br>바로 약속을 잡는다",
