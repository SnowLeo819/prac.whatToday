...
doc = [
    {'idx': 1, 'quiz': "코로나 시국 종료!<br>제일 먼저 가고 싶은 여행지는?", 'ans_01': "멋진 야경을 감상할 수 있는<br>뉴욕", 'ans_02': "다양한 액티비티가 가능한<br>스위스",
     'ans_03': "우아한 만찬과 낭만의 도시<br>프랑스", 'ans_04': "푸른 바다를 보며 휴식할 수 있는<br>괌"},
